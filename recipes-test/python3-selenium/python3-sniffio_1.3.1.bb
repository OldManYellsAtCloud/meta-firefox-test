...
inherit pypi python_setuptools_build_meta python3-dir
...
do_install:append(){
  mv ${D}${PYTHON_SITEPACKAGES_DIR}/UNKNOWN-0.0.0.dist-info ${D}${PYTHON_SITEPACKAGES_DIR}/sniffio-${PV}.dist-info
}
